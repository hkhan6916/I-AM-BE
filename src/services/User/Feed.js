...
//       accepted: true,
//     }, 'receiverId', { skip: connectionsAsSenderOffset || 0, limit: 5 });

//   const connectionsAsReceiver = await Connections.find({
//     receiverId: user._id,
//     accepted: true,
//   }, 'requesterId', { skip: connectionsAsReceiverOffset || 0, limit: 5 });
...
//   console.log('friends posts based feed', friendsPostsBasedFeed.length);
